      ...
      <nav className="flex-1 overflow-y-auto px-3 py-3 space-y-4">
            ...
            >
              ...
              <span className="[&_svg]:fill-none [&_path]:fill-none relative z-10">
                <Icon
                  ...
                  strokeWidth={1.4}
                  className={
                    screen === id ? "text-primary-500" : "text-text-200"
                  }
                />
              </span>
        ...
        <div>
          ...
          {NAV_OTHERS.map(({ label, icon: Icon }) => (
            <button
              key={label}
              className="w-full flex items-center gap-2.5 rounded-lg px-3 py-2 text-left text-[13px] text-text-50 hover:bg-background-soft-50 transition-colors"
            >
              <span className="[&_svg]:fill-none [&_path]:fill-none">
...
function PortafolioScreen() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-background-soft-50">
      {/* Top bar */}
      <div className="bg-background-50 border-b border-base-100 px-7 py-4 flex items-center justify-between">
              ...
              <AnimatePresence mode="wait">
                {paginated.map((c, i) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="text-text-50">{c.venc}</span>
                    </TableCell>
                    <TableCell>
                      <span className="text-text-50">{c.tipo}</span>
                    </TableCell>
                    <TableCell>
              ...
              <AnimatePresence mode="wait">
                {paginated.map((c, i) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="text-text-50 font-mono text-xs">
                        {c.extId}
                      </span>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <span className="text-text-50">{c.tel}</span>
                    </TableCell>
                    <TableCell>
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center p-6">
      ...
      <motion.div
        ...
        className="w-full max-w-[1200px] h-[780px] rounded-xl overflow-hidden shadow-2xl flex flex-col border border-white/10"
      >
        {/* Mac title bar */}
