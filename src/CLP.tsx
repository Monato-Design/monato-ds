...
const CLIENTES = [
  {
    ...
    monto: "$18,50.34",
    venc: "2024-06-15",
    tipo: "Software License",
    etapa: "Pre-vencimiento",
    estado: "Pendiente",
    sex: "M",
    extId: "2d8929amz9",
    tel: "33 2837 3789",
...
const ETAPA_COLOR: Record<
  string,
  "primary" | "success" | "warning" | "error" | "orange" | "gray" | "blue"
> = {
  "Pre-vencimiento": "primary",
  "Al día": "success",
  "Mora temprana": "orange",
  "Mora avanzada": "error",
};
const ESTADO_COLOR: Record<
  string,
  "success" | "primary" | "warning" | "error" | "gray" | "blue"
> = {
  Pagado: "success",
  Pendiente: "primary",
  Reprogramado: "blue",
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-title-50 text-2xl font-semibold tracking-tight mt-0.5">
          {value}
        </p>
            ...
            >
              ...
              {file ? (
                <div className="text-center">
                  ...
                  <p className="text-text-200 text-xs mt-0.5">
                ...
                <div className="text-center">
                  ...
                  <p className="text-text-200 text-xs mt-0.5">
                    o haz clic para seleccionar · Solo .CSV, hasta 50MB
                  </p>
                </div>
              )}
              {!file && (
            ...
            <div className="flex items-center gap-3 rounded-xl border border-base-100 bg-background-soft-50 px-4 py-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-title-50 text-xs font-medium">
                  Descarga la plantilla .CSV aquí
                </p>
                <p className="text-text-200 text-[11px] mt-0.5">
                  Campos: nombre, ID, teléfono, email, sexo (opc.), ID externo
                </p>
              </div>
        ...
        {uploadState !== "idle" && file && (
          <div className="rounded-xl border border-base-100 bg-background-50 px-4 py-3.5 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-title-50 text-sm font-medium truncate">
                  {file.name}
                </p>
...
const NAV_MAIN = [
  ...
  {
    id: "portafolio",
    label: "Portafolio de obligaciones",
  ...
  return (
    <aside className="h-full w-60 shrink-0 flex flex-col border-r border-base-100 bg-background-50">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-3 space-y-4">
        {/* Main menu */}
        <div>
          <p className="text-text-200 mb-1 px-2 text-[10px] font-semibold uppercase tracking-widest">
            Main menu
          </p>
  ...
  const HISTORIAL = [
    {
      ...
      desc: "John Doe joined your platform",
      time: "10 min ago",
    },
    {
      color: "bg-primary-500",
      title: "Portafolio actualizado",
      desc: "3,782 obligaciones sincronizadas",
      time: "1 hr ago",
    },
    {
      color: "bg-orange-500",
      title: "Alerta de mora detectada",
      desc: "Chance Philips — mora avanzada",
      time: "3 hr ago",
    },
  ];
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-title-50 text-xs font-semibold uppercase tracking-wider">
                  Account Info
                </p>
                <div className="space-y-3">
                  <div className="space-y-1.5">
                    <label className="text-text-100 text-xs font-medium">
                      Name
                    </label>
                    <input
                      value={name}
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button className="text-primary-500 text-xs font-medium hover:underline transition">
                    Ver todo
                  </button>
                </div>
                <div className="space-y-3">
                  {HISTORIAL.map((item, i) => (
                    ...
                    >
                      <div
                        className={`size-2 rounded-full ${item.color} mt-1.5 shrink-0`}
                      />
                  ...
                  <div className="flex items-center justify-between rounded-xl border border-base-100 px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-text-200 text-[11px]">
                  ...
                  <div className="flex items-center justify-between rounded-xl border border-base-100 px-4 py-3">
                    ...
                    <button
                      ...
                      style={{
                        height: "22px",
                        width: "40px",
                        backgroundColor: loginAlert ? "#0894c8" : "#e4e4e7",
                      }}
                    >
                      <motion.span
    ...
    <div className="flex-1 overflow-y-auto bg-background-soft-50">
      ...
      <div className="px-7 py-6 space-y-5">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          />
          <KpiCard
            icon={TrendUp1StrokeRounded}
            label="Performance del portafolio"
            value="3,782"
            sub="Índice general"
            trend="11.01%"
            delay={0.15}
          ...
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-base-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" appearance="outline">
                <span className="[&_svg]:fill-none [&_path]:fill-none">
                  <RefreshDollar1StrokeRounded size={13} strokeWidth={1.4} />
                </span>
                Actualizar portafolio
              </Button>
              <Button size="sm">
                <span className="[&_svg]:fill-none [&_path]:fill-none">
                  <Upload1StrokeRounded size={13} strokeWidth={1.4} />
                </span>
                Cargar portafolio
              </Button>
            </div>
            ...
            <thead>
              <tr>
                {[
                  ...
                  <th
                    key={h}
                    className="border-base-100 border-b px-5 py-3 text-xs font-medium text-text-100"
                  >
                ...
                {paginated.map((c, i) => (
                  ...
                  >
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        <div
                          className={`size-8 rounded-full ${AVATAR_COLORS[parseInt(c.id) % AVATAR_COLORS.length]} flex items-center justify-center text-white text-xs font-semibold shrink-0`}
                        >
                          {c.name
                            .split(" ")
                            .map((w) => w[0])
                        ...
                        <div>
                          <p className="text-title-50 text-sm font-medium leading-tight">
                            {c.name}
                          </p>
                    ...
                    <td className="px-5 py-3.5">
                      <span className="text-text-50 text-sm">{c.venc}</span>
                    </td>
                    <td className="px-5 py-3.5">
                      <span className="text-text-50 text-sm">{c.tipo}</span>
                    </td>
                    <td className="px-5 py-3.5">
                      <Badge color={ETAPA_COLOR[c.etapa] ?? "gray"} size="sm">
                        {c.etapa}
                      </Badge>
                    </td>
                    <td className="px-5 py-3.5">
                      <Badge color={ESTADO_COLOR[c.estado] ?? "gray"} size="sm">
                        {c.estado}
                      </Badge>
                    </td>
                  </motion.tr>
      ...
      <div className="px-7 py-6 space-y-5">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <KpiCard
            ...
            label="Obligaciones en mora"
            value="3,782"
            sub="Clientes con deuda vencida"
            trend="11.01%"
            delay={0.1}
          />
          <KpiCard
              ...
              <AnimatePresence mode="wait">
                {paginated.map((c, i) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <span className="text-text-50 text-sm">{c.tel}</span>
                    </td>
                    <td className="px-5 py-3.5">
                      <span className="text-text-50 text-sm">
                        {c.sex === "F" ? "Femenino" : "Masculino"}
                      </span>
                    </td>
                    <td className="px-5 py-3.5">
                      <Badge color={ESTADO_COLOR[c.estado] ?? "gray"} size="sm">
      ...
      <div className="rounded-xl border border-base-100 bg-background-50 overflow-hidden">
        ...
        <div className="p-6 flex items-center gap-6">
          ...
          <div className="flex-1 space-y-3">
            <div>
              <h3 className="text-title-50 text-base font-semibold">
                CLP — Cartera de Crédito
              </h3>
              <p className="text-text-100 text-sm mt-1">
                Prototipo navegable con 2 pantallas: Portafolio de obligaciones
                y Clientes. Incluye modal de carga de archivo.
              </p>
            </div>
