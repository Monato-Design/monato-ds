...
import {
  Home2StrokeRounded, DashboardSquare1StrokeRounded, Layers1StrokeRounded,
  ColourPalette3StrokeRounded, Code1StrokeRounded, Gear1StrokeRounded,
...
const NAV_GROUPS = [
  ...
  },
  {
    label: 'Components',
    items: [
      { id: 'buttons' as TabId,   label: 'Buttons',    icon: DashboardSquare1StrokeRounded },
      ...
      { id: 'feedback' as TabId,  label: 'Feedback',   icon: RefreshDollar1StrokeRounded },
      ...
      { id: 'modal' as TabId,     label: 'Modal',      icon: CreditCardMultipleStrokeRounded },
      { id: 'pagination' as TabId,'label': 'Pagination',icon: BarChart4StrokeRounded },
    ],
  },
  {
    label: 'Assets',
      ...
      <div className="rounded-xl border border-base-100 bg-background-50 overflow-hidden">
        <div className="flex items-center justify-between border-b border-base-100 px-5 py-4">
          ...
          <div className="relative">
            <Lineicons icon={Search1StrokeRounded} size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-text-200 pointer-events-none" />
            <input
              value={search}
    ...
    <div className="space-y-4">
      ...
      <PreviewCard label="Con ícono">
        <Button variant="primary" size="sm">
          <Lineicons icon={PlusStrokeRounded} size={14} />
          Nuevo pago
        </Button>
        <Button variant="primary" appearance="outline" size="sm">
          <Lineicons icon={Funnel1StrokeRounded} size={14} />
          Filtrar
        </Button>
      </PreviewCard>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-7 gap-3">
        {filtered.map(({ icon, name }) => (
          <div key={name} className="group flex flex-col items-center gap-2 rounded-xl border border-base-100 bg-background-50 p-4 hover:border-primary-500/40 hover:bg-primary-500/5 transition cursor-default">
            <Lineicons icon={icon} size={22} className="text-title-50 group-hover:text-primary-500 transition" />
      ...
      <div className="rounded-xl border border-base-100 bg-background-soft-50 p-4">
        <p className="text-text-100 text-xs">
          ...
          {' · '}
          <code className="bg-background-soft-100 px-1.5 py-0.5 rounded text-primary-500 text-[11px]">
            {`<Lineicons icon={Home2StrokeRounded} size={20} />`}
          </code>
        </p>
      </div>
    </div>
                ...
                {group.items.map(({ id, label, icon }) => (
                  ...
                  >
                    <Lineicons
                      icon={icon}
                      size={16}
                      className={active === id ? 'text-primary-500' : 'text-text-200'}
                    />
                    {label}
                    {id === 'overview' && (
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between border-b border-base-100 bg-background-50/90 px-8 py-3 backdrop-blur-sm">
          <div className="flex items-center gap-1.5 text-xs">
            ...
            <Lineicons icon={ChevronRightCircleBulkRounded} size={12} className="text-text-200" />
            <span className="text-title-50 font-medium capitalize">{active}</span>
          </div>
          <div className="flex items-center gap-2">
            <Button size="sm" appearance="outline">
              <Lineicons icon={Globe1StrokeRounded} size={13} />
              Figma
            </Button>
            <Button size="sm">
              <Lineicons icon={Code1StrokeRounded} size={13} />
              Usar componente
            </Button>
          </div>
        </div>
