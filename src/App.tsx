...
import {
  ...
  ColourPalette3StrokeRounded,
  Layout9StrokeRounded,
  Bolt2StrokeRounded,
  SlidersHorizontalSquare2StrokeRounded,
  CheckSquare2StrokeRounded,
  Comment1StrokeRounded,
  PaginationStrokeRounded,
  Diamonds1StrokeRounded,
...
const NAV_GROUPS: NavGroup[] = [
  {
    label: "General",
    items: [{ id: "overview", label: "Overview", icon: Home2StrokeRounded }],
  },
  {
    label: "Foundations",
    items: [
    ...
    children: [
      {
        ...
        items: [
          { id: "shadows", label: "Shadows", icon: Layers1StrokeRounded },
          {
            id: "spacing",
            label: "Spacing",
            icon: SlidersHorizontalSquare2StrokeRounded,
          },
          { id: "grid", label: "Grid Layouts", icon: Layout9StrokeRounded },
          {
            id: "border-radius",
            label: "Border Radius",
            icon: PaginationStrokeRounded,
          },
        ],
      },
    ],
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        sub="Tailgrids base · Monato tokens · Figma DS Web 2026"
      />
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          { label: "Tokens de color", value: 302, sub: "Mapeados al DS" },
          {
            ...
            value: COMPONENTS.reduce((a, r) => a + r.variants, 0),
            sub: "Across components",
          },
          { label: "Cobertura tokens", value: "302/302", sub: "100% mapeados" },
        ].map(({ label, value, sub, accent }) => (
          <div
            key={label}
            className={`rounded-xl border p-5 space-y-1.5 ${accent ? "border-primary-500/30 bg-primary-500/5" : "border-base-100 bg-background-50"}`}
          >
            <p className="text-text-200 text-xs font-medium uppercase tracking-wider">
              {label}
            </p>
            <p
              className={`text-3xl font-semibold tracking-tight ${accent ? "text-primary-500" : "text-title-50"}`}
            >
              {value}
            </p>
      ...
      <div className="rounded-xl border border-base-100 bg-background-50 overflow-hidden">
        <div className="flex items-center justify-between border-b border-base-100 px-5 py-4">
          <div className="flex items-center gap-3">
            <h3 className="text-title-50 text-sm font-semibold">
            ...
            <div className="flex gap-1.5">
              ...
              <Badge color="warning" size="sm">
                In progress{" "}
                {COMPONENTS.filter((r) => r.status === "in-progress").length}
              </Badge>
              <Badge color="gray" size="sm">
                Planned{" "}
                {COMPONENTS.filter((r) => r.status === "planned").length}
              </Badge>
            </div>
          </div>
          ...
          <TableBody>
            {paginated.map((row) => (
              <TableRow key={row.name}>
                ...
                <TableCell>
                  <span className="text-title-50 font-semibold">
                    {row.variants}
                  </span>
                </TableCell>
                <TableCell>
        ...
        <div className="border-t border-base-100 px-5 py-3 flex items-center gap-4">
          <span className="text-text-200 text-xs shrink-0">
            {filtered.length} componentes · página {page} de {totalPages}
          </span>
...
function ButtonsPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Buttons"
        sub="Acciones primarias, secundarias y de estado del sistema."
      />
      ...
      <PreviewCard label="Con ícono">
        <Button variant="primary" size="sm">
          <span className="[&_svg]:fill-none [&_path]:fill-none">
            <PlusStrokeRounded size={14} strokeWidth={1.4} />
          </span>
          Nuevo pago
        </Button>
        <Button variant="primary" appearance="outline" size="sm">
          <span className="[&_svg]:fill-none [&_path]:fill-none">
            <Funnel1StrokeRounded size={14} strokeWidth={1.4} />
          </span>
          Filtrar
        </Button>
      </PreviewCard>
...
function BadgesPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Badges"
        sub="Etiquetas de estado, categoría y contexto semántico."
      />
...
function InputsPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Inputs"
        sub="Campos de texto, selección y entrada de datos del sistema."
      />
...
function AlertsPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Alerts"
        sub="Mensajes de sistema, confirmaciones y advertencias."
      />
      <Alert
        variant="success"
        title="Pago procesado"
        message="El SPEI fue enviado y confirmado por el banco receptor."
      />
      <Alert
        variant="info"
        title="Información"
        message="Tu cuenta tiene pagos pendientes de conciliación."
      />
      <Alert
        variant="warning"
        title="Atención"
        message="El saldo disponible es menor al mínimo recomendado."
      />
      <Alert
        variant="danger"
        title="Error"
        message="No se pudo completar la transferencia. Intenta de nuevo."
      />
      <Alert
        variant="gray"
        title="Sin actividad"
        message="No hay movimientos en los últimos 30 días."
      />
    </div>
  );
}
...
function AvatarsPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Avatars"
        sub="Representación visual de usuarios y entidades."
      />
      <PreviewCard label="Tamaños">
...
function ControlsPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Controls"
        sub="Toggles, checkboxes y controles de formulario."
      />
...
function FeedbackPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Feedback"
        sub="Spinners, skeletons y estados de carga."
      />
...
function TabsPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Tabs"
        sub="Navegación entre vistas dentro de un mismo contexto."
      />
      <TabRoot defaultValue="pagos">
        ...
        <TabContent value="pagos">
          <p className="text-text-50 p-5 text-sm">Módulo de Pagos — BillPay.</p>
        </TabContent>
        <TabContent value="conciliacion">
          <p className="text-text-50 p-5 text-sm">Conciliación automática.</p>
        </TabContent>
        <TabContent value="credito">
          <p className="text-text-50 p-5 text-sm">Crédito — Finch by Monato.</p>
        </TabContent>
      </TabRoot>
    </div>
  );
...
function AccordionPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Accordion"
        sub="Contenido expandible para secciones colapsables."
      />
      <AccordionRoot>
        <AccordionItem>
          <AccordionTrigger>¿Qué es Monato?</AccordionTrigger>
          <AccordionContent>
            Infraestructura de pagos B2B para empresas en México.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem>
          <AccordionTrigger>¿Cómo funciona BillPay?</AccordionTrigger>
          <AccordionContent>
            BillPay procesa pagos B2B vía SPEI y CoDi con conciliación
            automática.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem>
          ...
          <AccordionContent>
            Finch es Crédito by Monato — líneas de crédito integradas a la misma
            API.
          </AccordionContent>
        </AccordionItem>
      </AccordionRoot>
...
function ToastPage() {
  return (
    <div className="space-y-4">
      <PageHeader
        title="Toast"
        sub="Notificaciones temporales no bloqueantes."
      />
      <div className="space-y-3 max-w-md">
        <Toast
          ...
          message={{
            title: "Pago procesado",
            description: "SPEI enviado correctamente.",
          }}
        />
        <Toast
          variant="success"
          message={{
            title: "Conciliado",
            description: "Transacción conciliada con éxito.",
          }}
        />
        <Toast
          variant="error"
...
function ModalPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Modal"
        sub="Diálogos bloqueantes para acciones críticas."
      />
        ...
        <div className="w-full max-w-md rounded-xl bg-background-50 p-6 shadow-lg space-y-5">
          <div>
            ...
            <p className="text-text-100 mt-1 text-sm">
              ¿Procesar $12,500 MXN vía SPEI a Proveedor ABC?
            </p>
          </div>
...
function PaginationPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Pagination"
        sub="Navegación entre páginas de contenido."
      />
...
function IconsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Icons"
        sub="Lineicons Free — StrokeRounded style · vía @lineiconshq/react-lineicons"
      />
      <div className="flex items-center gap-3">
        <div className="relative">
          <Search1StrokeRounded
            size={15}
            className="absolute left-3 top-1/2 -translate-y-1/2 text-text-200 pointer-events-none"
          />
          <input
            value={search}
          ...
          >
            <span className="[&_svg]:fill-none [&_path]:fill-none">
              <Icon
                size={22}
                strokeWidth={1.4}
                className="text-title-50 group-hover:text-primary-500 transition-colors"
              />
            </span>
            <span className="text-text-200 text-[10px] text-center leading-tight truncate w-full">
              {name}
            </span>
          </motion.div>
        ))}
  ...
  const PALETTES = [
    {
      ...
      shades: [
        { shade: "50", hex: "#e6f4fa" },
        { shade: "100", hex: "#b2deee" },
        { shade: "200", hex: "#8dcee6" },
        { shade: "300", hex: "#5ab7da" },
        { shade: "400", hex: "#39a9d3" },
        { shade: "500", hex: "#0894c8" },
        { shade: "600", hex: "#0787b6" },
        { shade: "700", hex: "#06698e" },
        { shade: "800", hex: "#04516e" },
        { shade: "900", hex: "#033e54" },
      ],
    },
    {
      name: "Gray",
      ...
      shades: [
        ...
        { shade: "200", hex: "#a1a1aa" },
        { shade: "300", hex: "#71717a" },
        { shade: "400", hex: "#52525b" },
        { shade: "500", hex: "#3f3f46" },
        { shade: "600", hex: "#27272a" },
        { shade: "700", hex: "#1e1e22" },
        { shade: "800", hex: "#18181b" },
        { shade: "900", hex: "#09090b" },
      ],
    },
    {
      name: "Red",
      ...
      shades: [
        { shade: "50", hex: "#ffebed" },
        { shade: "100", hex: "#fec1c6" },
        { shade: "300", hex: "#fc7984" },
        { shade: "500", hex: "#fb3748" },
        { shade: "600", hex: "#e43242" },
        { shade: "700", hex: "#b22733" },
        { shade: "800", hex: "#8a1e28" },
        { shade: "900", hex: "#69171e" },
      ],
    },
    {
      name: "Green",
    ...
    },
    {
      ...
      shades: [
        { shade: "50", hex: "#fef8e9" },
        { shade: "100", hex: "#fce8b9" },
        { shade: "300", hex: "#f9cd68" },
        { shade: "500", hex: "#f6b51e" },
        { shade: "600", hex: "#e0a51b" },
        { shade: "700", hex: "#af8115" },
        { shade: "800", hex: "#876411" },
        { shade: "900", hex: "#674c0d" },
      ],
    },
  ];
  return (
    <div className="space-y-4">
      <div className="mb-8 pb-6 border-b border-base-100">
        ...
        <p className="text-text-100 mt-1 text-sm">
          Paleta de primitivos · Sincronizada desde Figma DS Web 2026
        </p>
      </div>
      <div className="space-y-8">
            ...
            <div className="flex gap-2 flex-wrap">
              {shades.map(({ shade, hex }) => (
                ...
                >
                  ...
                  />
                  <p className="text-text-200 text-[10px] font-medium">
                    {shade}
                  </p>
                  <p className="text-text-200 text-[9px] font-mono uppercase">
                    {hex}
                  </p>
                </motion.div>
              ))}
  ...
  return (
    <div className="space-y-10">
      <div className="pb-6 border-b border-base-100">
        ...
        <p className="text-text-100 mt-1 text-sm">
          DM Sans · Escala tipográfica del DS
        </p>
      </div>
      {/* Scale */}
      <div>
          ...
          {SCALE.map(({ token, size, lh, label }, i) => (
            ...
            >
              <div className="w-32 shrink-0">
                ...
                <p className="text-text-200 text-[10px] mt-0.5">
                  {size} / {lh}
                </p>
              </div>
              <p
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-4">
          {WEIGHTS.map(({ value, label }) => (
            <div
              key={label}
              className="rounded-xl border border-base-100 p-5 space-y-2"
            >
              <p
                style={{
                  fontWeight: value,
...
function ShadowsPage() {
  const SHADOWS = [
    ...
    {
      name: "sm",
      value: "0px 1px 3px 0px rgba(16,24,40,0.1)",
      token: "--shadow-sm",
    },
    {
      name: "md",
      value: "0px 4px 8px -2px rgba(16,24,40,0.1)",
      token: "--shadow-md",
    },
    {
      name: "lg",
      value: "0px 12px 16px -4px rgba(16,24,40,0.08)",
      token: "--shadow-lg",
    },
    {
      name: "xl",
      value: "0px 20px 24px -4px rgba(16,24,40,0.08)",
      token: "--shadow-xl",
    },
    {
      name: "2xl",
      ...
      <div className="grid grid-cols-3 gap-6">
        {SHADOWS.map(({ name, value, token }, i) => (
          ...
          >
            ...
            <p className="text-text-200 text-[11px] font-mono leading-relaxed">
              {value}
            </p>
          </motion.div>
        ))}
  ...
  return (
    <div className="space-y-6">
      <div className="pb-6 border-b border-base-100">
        ...
        <p className="text-text-100 mt-1 text-sm">
          Escala base-4 · {TOKENS.length} tokens
        </p>
      </div>
      <div className="space-y-2">
        {TOKENS.map(({ token, px }, i) => (
          ...
          >
            <p className="text-text-200 text-xs font-mono w-20 shrink-0">
              --space-{token}
            </p>
            <p className="text-text-200 text-xs w-10 shrink-0">{px}</p>
            <div
              className="bg-primary-500/30 rounded"
              style={{ width: px, height: "8px", minWidth: "2px" }}
            />
          </motion.div>
        ))}
      </div>
        ...
        {TOKENS.map(({ name, token, px, sample }, i) => (
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-text-200 text-[9px] font-mono mt-0.5 truncate w-full">
                {token}
              </p>
            </div>
          </motion.div>
  ...
  return (
    <div className="space-y-8">
      <div className="pb-6 border-b border-base-100">
        ...
        <p className="text-text-100 mt-1 text-sm">
          Sistema de grillas · gap-4 (16px) por defecto
        </p>
      </div>
      <div className="space-y-6">
        {GRIDS.map(({ cols, label, use }, i) => (
          ...
          >
            ...
            <div
              ...
              style={{
                gridTemplateColumns: `repeat(${Math.min(cols, 12)}, 1fr)`,
              }}
            >
              {Array.from({ length: Math.min(cols, 12) }).map((_, j) => (
                <div
                  key={j}
                  className="h-8 rounded-md bg-primary-500/15 border border-primary-500/20"
                />
              ))}
            </div>
          </motion.div>
    ...
    <div className="space-y-4">
      <div className="mb-8 pb-6 border-b border-base-100">
        ...
        <p className="text-text-100 text-sm">
          Pantallas navegables construidas con componentes del DS.
        </p>
      </div>
      <CLP />
    </div>
      ...
      >
        <span className="[&_svg]:fill-none [&_path]:fill-none shrink-0">
          <Layers1StrokeRounded
            size={16}
            strokeWidth={1.4}
            className={hasActive ? "text-primary-500" : "text-text-200"}
          />
        </span>
                ...
                >
                  <span className="[&_svg]:fill-none [&_path]:fill-none shrink-0">
                    <Icon
                      ...
                      strokeWidth={1.4}
                      className={
                        active === id ? "text-primary-500" : "text-text-200"
                      }
                    />
                  </span>
                  <span>{label}</span>
      ...
      <aside className="sticky top-0 h-screen w-60 shrink-0 flex flex-col border-r border-base-100 bg-background-50">
                  ...
                  >
                    ...
                    {id === "overview" && (
                      <span className="ml-auto relative z-10">
                        <Badge color="primary" size="sm">
                          {
                            COMPONENTS.filter((c) => c.status === "stable")
                              .length
                          }
                        </Badge>
                      </span>
        ...
        <div className="border-t border-base-100 px-4 py-3 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-title-50 truncate text-xs font-medium">
              Monato Design
            </p>
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between border-b border-base-100 bg-background-50/90 px-8 py-3 backdrop-blur-sm">
          <div className="flex items-center gap-1.5 text-xs">
            ...
            <ChevronRightCircleBulkRounded
              ...
              className="text-text-200"
            />
            <span className="text-title-50 font-medium capitalize">
              {active}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <Button size="sm" appearance="outline">
              <span className="[&_svg]:fill-none [&_path]:fill-none">
                <Globe1StrokeRounded size={13} strokeWidth={1.4} />
              </span>
              Figma
            </Button>
            <Button size="sm">
              <span className="[&_svg]:fill-none [&_path]:fill-none">
                <Code1StrokeRounded size={13} strokeWidth={1.4} />
              </span>
              Usar componente
            </Button>
          </div>
