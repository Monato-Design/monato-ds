    ...
    items: [
      {
        id: "buttons" as TabId,
        label: "Buttons",
        icon: DashboardSquare1StrokeRounded,
      },
      { id: "badges" as TabId, label: "Badges", icon: Layers1StrokeRounded },
      { id: "inputs" as TabId, label: "Inputs", icon: Code1StrokeRounded },
      { id: "alerts" as TabId, label: "Alerts", icon: Bell1StrokeRounded },
      { id: "avatars" as TabId, label: "Avatars", icon: User4StrokeRounded },
      { id: "controls" as TabId, label: "Controls", icon: Gear1StrokeRounded },
      {
        id: "feedback" as TabId,
        label: "Feedback",
        icon: RefreshDollar1StrokeRounded,
      },
      { id: "tabs" as TabId, label: "Tabs", icon: CalendarDaysStrokeRounded },
      {
        id: "accordion" as TabId,
        label: "Accordion",
        icon: FileMultipleStrokeRounded,
      },
      { id: "toast" as TabId, label: "Toast", icon: CheckCircle1StrokeRounded },
      {
        id: "modal" as TabId,
        label: "Modal",
        icon: CreditCardMultipleStrokeRounded,
      },
      {
        id: "pagination" as TabId,
        label: "Pagination",
        icon: BarChart4StrokeRounded,
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "icons" as TabId,
        label: "Icons",
        icon: ColourPalette3StrokeRounded,
      },
    ],
  },
];
...
const ICON_SHOWCASE = [
  ...
  { icon: DashboardSquare1StrokeRounded, name: "Dashboard" },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-7 gap-3">
        {filtered.map(({ icon: Icon, name }) => (
          <div
            key={name}
            className="group flex flex-col items-center gap-2 rounded-xl border border-base-100 bg-background-50 p-4 hover:border-primary-500/40 hover:bg-primary-500/5 transition cursor-default"
          >
            <Icon
              size={22}
              className="text-title-50 group-hover:text-primary-500 transition"
            />
            <span className="text-text-200 text-[10px] text-center leading-tight truncate w-full text-center">
              {name}
            </span>
          </div>
        ))}
