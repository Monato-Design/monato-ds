...
export function TimePicker({
  ...
  return (
    <MenuTrigger>
      {children}
      <Popover className="bg-background-50 border-base-100 rounded-xl border p-2 shadow-lg outline-none">
...
function TimeColumn({
  ...
  return (
    <div className="flex max-h-73 flex-col gap-1 overflow-y-auto pr-1.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      {values.map((value) => (
        <button
          key={value}
          onClick={() => {
